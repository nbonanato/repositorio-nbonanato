 ...
 * @author Nicholas
 */
@WebServlet(name = "BoasVindasServlet", urlPatterns = {"/BoasVindasServlet.html"})
public class BoasVingasServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            out.println("<!DOCTYPE html>");
            	...
            	out.println("</head>");
            out.println("<body>");
            out.println("<h1>Aula 2 - Servlets! </h1>");
            out.println("<h2>Opa, bem-vindo!</h2>");
